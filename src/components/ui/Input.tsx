    ...
    return (
      <div className="w-full space-y-1.5">
        ...
        <input
          ...
          ref={ref}
          className={cn(
            "w-full min-h-[48px] px-4 rounded-xl border border-warm-border bg-warm-card text-warm-dark placeholder:text-warm-muted/60 text-sm focus:outline-none focus:ring-2 focus:ring-warm-primary/30 focus:border-warm-primary transition-all duration-150 disabled:opacity-50",
